...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/sales-history', name: 'sales-history', component: () => import('../pages/SalesHistoryPage.vue'), meta: { roles: ['ADMIN', 'CASHIER'] } },
    { path: '/receipt-detail', name: 'receipt-detail', component: () => import('../pages/ReceiptDetailPage.vue'), meta: { roles: ['ADMIN', 'CASHIER'] } },
