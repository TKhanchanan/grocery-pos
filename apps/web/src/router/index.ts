...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/procurement', name: 'procurement', component: () => import('../pages/ProcurementPage.vue'), meta: { permissions: ['purchase_orders.view', 'suppliers.view'] } },
    { path: '/purchase-orders', redirect: (to) => ({ path: '/procurement', query: { ...to.query, tab: 'purchase-orders' } }) },
    { path: '/suppliers', redirect: (to) => ({ path: '/procurement', query: { ...to.query, tab: 'suppliers' } }) },
