...
<template>
  <button
    ...
    :class="{
      'bg-brand-600 text-white shadow-brand-600/20 hover:bg-brand-700 dark:bg-teal-300 dark:text-slate-950 dark:hover:bg-teal-200': variant === 'primary',
      'bg-white/85 text-slate-700 shadow-sm hover:bg-brand-50 dark:bg-slate-900/85 dark:text-slate-100 dark:hover:bg-teal-400/10': variant === 'secondary',
      ...
      'text-slate-600 shadow-none hover:bg-brand-50 dark:text-slate-200 dark:hover:bg-teal-400/10': variant === 'ghost',
    }"
  >
