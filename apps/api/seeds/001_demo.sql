...
((SELECT id FROM products WHERE sku='EGG-SALTED'), (SELECT id FROM locations WHERE name='หน้าร้าน'), 12),
((SELECT id FROM products WHERE sku='EGG-SALTED'), (SELECT id FROM locations WHERE name='คลังหลัก'), 50),
((SELECT id FROM products WHERE sku='MAMA-001'), (SELECT id FROM locations WHERE name='หน้าร้าน'), 100),
((SELECT id FROM products WHERE sku='MAMA-001'), (SELECT id FROM locations WHERE name='คลังหลัก'), 200),
((SELECT id FROM products WHERE sku='SODA-001'), (SELECT id FROM locations WHERE name='หน้าร้าน'), 5),
((SELECT id FROM products WHERE sku='SODA-001'), (SELECT id FROM locations WHERE name='คลังหลัก'), 60)
...
SELECT 'Sample Grocery Supplier', '020000000', 'supplier@example.com', 'Bangkok'
WHERE NOT EXISTS (SELECT 1 FROM suppliers WHERE name='Sample Grocery Supplier');
