...
func (s *Server) Routes() http.Handler {
	...
	mux.HandleFunc("GET /api/v1/imports/products/template", s.requireAllPermissions(s.productImportTemplate, "products.import", "imports.template.download"))
	mux.HandleFunc("POST /api/v1/imports/products/preview", s.requireAllPermissions(s.productImportPreview, "products.import", "imports.products.preview"))
	mux.HandleFunc("POST /api/v1/imports/products/confirm", s.requireAllPermissions(s.productImportConfirm, "products.import", "imports.products.confirm"))
